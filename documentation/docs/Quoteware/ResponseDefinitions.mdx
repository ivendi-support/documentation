...
| Product quote Figure | Repossession | Double | Amount of loan paid when the asset cannot be reposessed by creditor for none payment of loan| Quote dependent|
...
| Product quote Figure | InitialPause | Integer | The number of period before payments start| Typically 0 to 3|
...
| Grouping | Property | Type | Description |Value|
| --- | --- | --- | --- | --- |
| Product quote asset | AnnualDistanceQuoted | Integer| The actual distance used for this quote. Some finance products have min and max distance constraints. In order to return as many quotes the distance may be altered by Quoteware|Typically 5000 to 45000|
| Product quote asset | ChargePerOverDistanceUnit | Double| Some finance products charge for exceeding the contract distance quoted. For the UK region finance prodcts this typically will be a few pence per mile, returned as Pounds Steriling|Typically 0.0 to 0.50|
...
| Grouping | Property | Type | Description |Value|
| --- | --- | --- | --- | --- |
| Early settlement | Amount | Double| Money amount of the early settlment type |0 to < Advance|
