...
|`excludeVatAsDeposit`|true or false|If true, the VAT will not be counted towards the deposit, and the deposit will be a cash deposit rather than an additional deposit. If false, the VAT will be counted towards the deposit, and any cash deposit will be an additional deposit.|
