...
|Credit Tiers|string|An array of string values that map to the credit tier products available.For more information on credit tiers please see [credit tiers](./CreditTiers.mdx)|
