...
The table on this page contains the full definition and all parameters available in a quoteware request.
...
|UID| GlobalRequestParameters |RequestParameters|If given, then these parameteres override any preconfigured parameters. Do not override unless given a specific need discussed with iVendi|RequestParameters Object|
|UID| `Requests` |Request (Array)|Details of the assets and figures to quote for|Array of 1 or more Request objects|
|RequestSettings| SortBy|SortBy (Enum)|The order any quotes will be returned in. Best quote presented in array position 0 |Default 0, Commision 0, Payment 2, APR 3|
...
|RequestParameters| CommissionType | CommissionType (Enum) |Used in combination with Commission and ComputationPath  |Default 0, Fixed Amount 1, Percentage of Cash Price 2, Precentage of Advance 3|
...
|RequestParameters| Term | Integer | Preiod the quotation should be calculated over |Typically 12 to 60 or 52 to 260|
...
|Request Asset| `Condition` | MotorVehicleCondition (Enum) |Whether the vehicle is new or used | Defualt 0, New 1, Used 2|
|Request Asset| Source | MotorVehicleSource (Enum) |Whether the vehicle is from the current region| Defualt 0, Region Current 1, Region European Union 2, Region Grey 3|
...
|Request Asset|`Class` | MotorVehicleClasee (Enum) |Type of vehicle|Default 0, Car 1, LCV 2, Motorbike 3|
...
|Request figures Asset| VATQualifying | Boolean | Is the asset VAT Qualifiying. Normally used for commercial Assets where VAT has been reclaimed|True/False|
